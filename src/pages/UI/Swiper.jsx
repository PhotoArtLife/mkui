...
import {Grid,Button,Panel,Swiper} from '../../mkui/index'
...
class Dom extends Component {
    ...
    render(){
        return (
            <Panel header="Swiper">
                <Swiper autoPlay={3000} button={true} style={{width:600}} activeIndex="0" animate="move" changeback={this.changeback.bind(this)}>
                    <SwiperItem>
                        <img src="//kquanr.com/files/blog/slickImgs/1.jpg" style={{width: '100%'}} />
                    </SwiperItem>
                    <SwiperItem>
                        <img src="//kquanr.com/files/blog/slickImgs/2.jpg" style={{width: '100%'}} />
                    </SwiperItem>
                    <SwiperItem>
                        <img src="//kquanr.com/files/blog/slickImgs/3.jpg" style={{width: '100%'}} />
                    </SwiperItem>
                    <SwiperItem>
                        <img src="//kquanr.com/files/blog/slickImgs/4.jpg" style={{width: '100%'}} />
                    </SwiperItem>
                    <SwiperItem>
                        <img src="//kquanr.com/files/blog/slickImgs/5.jpg" style={{width: '100%'}} />
                    </SwiperItem>
                </Swiper>
<div className="api">
    <p className="tips">
